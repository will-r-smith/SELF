...
if __name__ == '__main__':
    ...
    parser.add_argument('--test', type=str, default="intervene", choices=['intervene', 'evaluate', 'fine_tune'])
    parser.add_argument('--model', type=str, default="roberta", choices=['pythia', 'roberta', 'gptj'], help="Which model to evaluate")
