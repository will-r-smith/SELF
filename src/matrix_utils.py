...
def relative_error(original_mat, approx_mat):
...
def do_lr(model, name, weight, k):
    ...
    return model, weight_approx, [f"{param_name_base}_U", f"{param_name_base}_S", f"{param_name_base}_Vt"]
